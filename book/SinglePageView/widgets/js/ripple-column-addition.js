...
(function() {
  var black, interactive_color, botOpacity, darkgray, fontfamily, gray, green, orange, interactive_color, red, teal, topOpacity, white, yellow;
  ...
  interactive_color = interactive_color;
  red = '#999';
  darkgray = '#5f5f5f';
  teal = gray;
